...
Class create_model extends CI_Model
{
	function new_room($slug, $password)
	{
	    ...
	    'showName' => 'Welcome',
	    'showDescription' => 'This is a freshly created room. If you are the owner, go to channelcentral.me/'.$slug.'/host and make it your home, invite over friends, and share videos',
